      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-body">  
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-4 control-label">Keluhan</label>
                <div class="row">
                  <div class="col-sm-12">
                      <textarea name="keluhan" id="keluhan" row='6' class="form-control" value="" required placeholder="keluhan" require></textarea>
                  </div>
                </div>
              </div>          
              
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-4 control-label">Diagnosa</label>
                <div class="row">
                  <div class="col-sm-12">
                      <textarea name="diagnosa" id="diagnosa" row='6' class="form-control" value="" required placeholder="Diagnosa" require></textarea>
                  </div>
                </div>
              </div>          
...
<script>
    var baseUrl = "{{url('/pemeriksaandokter')}}/";
