...
<div class="row match-height">
    <div class="col-md-12">
        <p align='right'><a href="/pengguna"><span class="fa fa-caret-left"></span> Kembali ke Tabel Pengguna</a></p>
    </div>
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title-wrap bar-info">
                    <h4 class="card-title" id="basic-layout-round-controls">{{$judulmodul}}</h4>
                </div>
            ...
            <div class="card-body">
                ...
                <p class="mb-0"><b><i>Kolom bertanda <code>*)</code> tidak boleh kosong.</i></b></p>
                    <form class="form" action="javascript:save()" method="post" id="form1" name="form1">
                        {{csrf_field()}}
                       <input type="hidden" name="id" id="id" value="{{$query->id_user}}">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  maxlength="16" id="nik" name="nik" placeholder="Masukkan NK" required value="{{$query->nik}}">

                                    </div>

                                    <div class="form-group">
                                        <label for="nama">Nama Lengkap<span class="text-danger text-bold">*)</span></label>
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Lengkap" required value="{{$query->nama}}">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Masukan Username anda." disabled autofocus value="{{$query->username}}">
...
<script>
    var baseUrl = "{{url('/pengguna')}}/";
        ...
        function save() {
            ...
            // Validasi
            if (nik === '' || nama === '' || jabatan === '') {
                call_alert('warning', 'Validasi Gagal', 'NIK, Nama, dan Jabatan wajib diisi.');
                return;
            }
